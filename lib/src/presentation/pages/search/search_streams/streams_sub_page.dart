...
class StreamsSubPage extends StatelessWidget {
  StreamsSubPage({Key? key}) : super(key: key);
          ...
          child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return InkWell(
                  onTap: () {
                    Get.toNamed(
                      AppRoutes.STREAMS_SUB_DETAILS_PAGE,
  ...
  List<String> educationPageItemsIcons = [
    AppImages.STREAMS_MATH,
    AppImages.STREAMS_ENGLISH,
    AppImages.STREAMS_RUSSIAN,
    AppImages.STREAMS_PHYSICS,
    AppImages.STREAMS_IT,
    AppImages.STREAMS_WEB,
  ];
