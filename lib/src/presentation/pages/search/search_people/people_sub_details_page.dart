...
class PeoplesSubDetailsPage extends StatelessWidget {
  PeoplesSubDetailsPage({Key? key}) : super(key: key);
        ...
        Expanded(
          child: Padding(
            ...
            child: ListView.builder(
                itemCount: peopleSubDetailsImages.length,
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                    leading: Image.asset(
                      peopleSubDetailsImages[index],
                    ...
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          peopleSubDetailsSubtitles[index],
                          style: TextStyle(
                            fontSize: SizeConfig.calculateTextSize(14),
                        ...
                        Text(
                          peopleSubDetailsDescriptions[index],
                          style: TextStyle(
  ...
  final List<String> peopleSubDetailsImages = [
    AppImages.DIYORJON,
    AppImages.DIYORA,
    AppImages.DIYORA,
    AppImages.DIYORA,
  ...
  final List<String> peopleSubDetailsTitles = [
    "Eshdavlatov\nUmidjon",
    "Umarova Diyora",
    "Umarova Diyora",
    "Umarova Diyora",
  ...
  final List<String> peopleSubDetailsSubtitles = [
    "Dermatologists",
    "Dermatologists",
    "Dermatologists",
    "Dermatologists",
  ...
  final List<String> peopleSubDetailsDescriptions = [
    "Work at MARKAZIY TEMIR YO'L...",
    "Work at MARKAZIY TEMIR YO'L...",
    "Work at MARKAZIY TEMIR YO'L...",
    "Work at MARKAZIY TEMIR YO'L...",
    "Work at MARKAZIY TEMIR YO'L...",
