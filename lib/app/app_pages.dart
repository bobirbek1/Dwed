...
import 'package:flutter_template/features/login/presentation/pages/create_account/create_account_gender_page.dart';
...
import 'package:flutter_template/features/login/presentation/pages/create_account/create_account_number_page.dart';
import 'package:flutter_template/features/login/presentation/pages/create_account/create_account_password_page.dart';
import 'package:flutter_template/features/login/presentation/pages/create_account/create_account_specialty.dart';
import 'package:flutter_template/features/login/presentation/pages/create_account/reset_password_new.dart';
import 'package:flutter_template/features/login/presentation/pages/create_account/reset_password_phone.dart';
import 'package:flutter_template/features/login/presentation/pages/create_account/reset_password_verify.dart';
import 'package:flutter_template/features/login/presentation/pages/login/login_page.dart';
import 'package:flutter_template/features/login/presentation/pages/splash/on_boarding_page.dart';
import 'package:flutter_template/features/login/presentation/pages/splash/slpash_page.dart';
